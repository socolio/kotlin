...
class A(outer: Outer) {
    ...
    var e: String by  <!DELEGATE_SPECIAL_FUNCTION_NONE_APPLICABLE, TYPE_MISMATCH!>+ foo(getMyProperty())<!>
    var f: String by  <!DELEGATE_SPECIAL_FUNCTION_NONE_APPLICABLE, TYPE_MISMATCH!>foo(getMyProperty()) - 1<!>
}
