...
class IrDeclarationDeserializer(
        ...
        withDeserializedIrDeclarationBase(proto.base) { symbol, signature, startOffset, endOffset, origin, fcode ->
            ...
            symbolTable.declareClass(signature, { symbol as IrClassSymbol }) {
                ...
                if (!skipMutableState) {
                    ...
                    inlineClassRepresentation = deserializeInlineClassRepresentation(proto)
    ...
    private fun deserializeInlineClassRepresentation(proto: ProtoClass): InlineClassRepresentation<IrSimpleType>? {
        ...
        return deserializeInlineClassRepresentation(proto.inlineClassUnderlyingPropertyName, proto.inlineClassUnderlyingPropertyType)
    }

    fun deserializeInlineClassRepresentation(name: Int, type: Int): InlineClassRepresentation<IrSimpleType> =
        InlineClassRepresentation(deserializeName(name), deserializeIrType(type) as IrSimpleType)
