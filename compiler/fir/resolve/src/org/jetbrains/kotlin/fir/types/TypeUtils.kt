...
fun ConeDefinitelyNotNullType.Companion.create(
    ...
    return when {
        ...
        typeContext
            ...
            .makesSenseToBeDefinitelyNotNull(original, useCorrectedNullabilityForFlexibleTypeParameters) -> ConeDefinitelyNotNullType(original.lowerBoundIfFlexible())
        else -> null
    }
}
...
fun ConeKotlinType.makeConeTypeDefinitelyNotNullOrNotNull(typeContext: ConeTypeContext): ConeKotlinType {
    ...
    return ConeDefinitelyNotNullType.create(this, typeContext) ?: this.withNullability(ConeNullability.NOT_NULL)
}
